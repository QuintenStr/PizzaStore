...
namespace PizzaStore.Migrations
{
    ...
    [Migration("20230516163957_OrdersChange2")]
    partial class OrdersChange2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaStore.Data.OrderLine", b =>
                {
                    ...
                    b.Property<int?>("DeliveryOrderOrderId")
                        .HasColumnType("int");

                    b.Property<int?>("PickupOrderOrderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveryOrderOrderId");

                    b.HasIndex("PickupOrderOrderId");
            ...
            modelBuilder.Entity("PizzaStore.Data.OrderLine", b =>
                {
                    b.HasOne("PizzaStore.Data.DeliveryOrder", null)
                        .WithMany("OrderLines")
                        .HasForeignKey("DeliveryOrderOrderId");

                    b.HasOne("PizzaStore.Data.PickupOrder", null)
                        .WithMany("OrderLines")
                        .HasForeignKey("PickupOrderOrderId");
